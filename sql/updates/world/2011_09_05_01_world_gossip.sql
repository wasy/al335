...
(9691, 0, 3, 'I seek training, Lady Alistra.', 5, 16, 0, 0, 0, 0, NULL),
(9691, 1, 0, 'I wish to unlearn my talents.', 1, 1, 4461, 0, 0, 0, NULL),
(9691, 2, 0, 'Learn about Dual Talent Specialization.', 1, 1, 10371, 0, 0, 0, NULL),
(9692, 0, 3, 'I seek training, Lord Thorval.', 5, 16, 0, 0, 0, 0, NULL),
(9692, 1, 0, 'I wish to unlearn my talents.', 1, 1, 4461, 0, 0, 0, NULL),
(9692, 2, 0, 'Learn about Dual Talent Specialization.', 1, 1, 10371, 0, 0, 0, NULL),
(9693, 0, 3, 'I seek training, Amal''thazad.', 5, 16, 0, 0, 0, 0, NULL),
(9693, 1, 0, 'I wish to unlearn my talents.', 1, 1, 4461, 0, 0, 0, NULL),
(9693, 2, 0, 'Learn about Dual Talent Specialization.', 1, 1, 10371, 0, 0, 0, NULL),
(9791,0,0,'Yes. I do.',16,16,0,0,0,0,NULL),
(10371, 0, 2, 'Purchase a Dual Talent Specialization.', 18, 16, 10373, 0, 0, 10000000, 'Are you sure you wish to purchase a Dual Talent Specialization?');
...
INSERT INTO `gossip_menu_option` (`menu_id`, `id`, `option_icon`, `option_text`, `option_id`, `npc_option_npcflag`, `action_menu_id`, `action_poi_id`, `box_coded`, `box_money`, `box_text`) VALUES
(10027, 0, 3, 'I require training, Highlord.', 5, 16, 0, 0, 0, 0, NULL);