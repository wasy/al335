    ...
    case 2:
        {
            ...
            sWorld->BanAccount(BAN_ACCOUNT, accountName, duration.str(), "Обнаружено нарушение правил игры, рекомендуется посетить соответствующий раздел форума. ","Anticheat");
