...
public:
    ...
    bool OnGossipSelect(Player* pPlayer, Creature* creature, uint32 /*uiSender*/, uint32 uiAction)
    {
        ...
        {
            CAST_AI(npc_pusillinAI, creature->AI())->Start(false, true, pPlayer->GetGUID());
